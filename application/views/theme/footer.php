<footer class="footer">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <img width="150" src="<?php echo base_url('');?>style/img/identitas/logosd.png" class="rounded" alt="">
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> <a href="#" target="_blank" style="color:red ;">SD Pilar Nusantara</a> </p>
                        </p>
                    </div>
                </div>
            </div>
