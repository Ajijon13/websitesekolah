<footer class="footer">
    ...
    <ul class="social-icon">
        <li class="social-icon__item"><a class="social-icon__link" href="https://www.facebook.com/profile.php?id=100015120006162&mibextid=LQQJ4d" target="_blank">
                <ion-icon name="logo-facebook"></ion-icon>
            </a></li>
        <li class="social-icon__item"><a class="social-icon__link" href="https://youtube.com/@sdpinustuban2576" target="_blank">
                <ion-icon name="logo-youtube"></ion-icon>
            </a></li>
        <li class="social-icon__item"><a class="social-icon__link" href="https://www.instagram.com/reel/CkPSkIVhHun/?igshid=Zjc2ZTc4Nzk=" target="_blank">
    ...
    <ul class="menu">
        ...
        <li class="menu__item"><a class="menu__link" href="<?php echo site_url('agenda'); ?>">Agenda</a></li>
        <li class="menu__item"><a class="menu__link" href="<?php echo site_url('pengumuman'); ?>">Pengumuman</a></li>
        <li class="menu__item"><a class="menu__link" href="<?php echo site_url('guru');?>">Daftar Guru</a></li>
    </ul>
    <ul class="menu">
    <img width="80" src="<?php echo base_url('');?>style/img/identitas/logosd.png" class="rounded" alt="">
    <img width="90" src="<?php echo base_url('');?>style/img/identitas/logosmp.png" class="rounded" alt="">
    </ul>
    <p>
        Copyright &copy;<script>
            document.write(new Date().getFullYear());
        </script> <a href="#" target="_blank" style="color:black ;">SD Pilar Nusantara</a> </p>
    </p>
    </div>
</footer>
